# 확인사항: HTML 속성 - Img와 앵커 태그

이전 강의에서 배운것을 이해했는지 확인해 봅시다. 지침을 주의 깊게 읽어주세요!

코딩 연습 확인사항: Img와 Anchor 태그

임무: "test.png" 이미지를 보여주는 웹사이트를 만드세요. "Image not available"이라는 대체 텍스트를 꼭 추가해야 합니다. 또한 이미지 아래에 링크 텍스트 'Udemy'와 함께 www.udemy.com 링크가 포함된 단락을 만드세요. 평소와 같이 HTML 헤더도 만드세요.
